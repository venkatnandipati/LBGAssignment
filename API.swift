...
public struct ProductFilterInput: GraphQLMapConvertible {
  ...
  public init(query: Swift.Optional<String?> = nil, type: Swift.Optional<[ProductType]?> = nil, brands: Swift.Optional<[String]?> = nil, cyl: Swift.Optional<[LensCylinder]?> = nil, lensDesign: Swift.Optional<[LensDesign]?> = nil, category: Swift.Optional<ProductCategory?> = nil, lensIndex: Swift.Optional<[LensIndex]?> = nil, frameSize: Swift.Optional<FrameSize?> = nil, shape: Swift.Optional<[ProductShape]?> = nil, colorIds: Swift.Optional<[Double]?> = nil, includeOutOfStock: Swift.Optional<Bool?> = nil, includeInactiveVariants: Swift.Optional<Bool?> = nil) {
    graphQLMap = ["query": query, "type": type, "brands": brands, "cyl": cyl, "lensDesign": lensDesign, "category": category, "lensIndex": lensIndex, "frameSize": frameSize, "shape": shape, "colorIds": colorIds, "includeOutOfStock": includeOutOfStock, "includeInactiveVariants": includeInactiveVariants]
  }
